...
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
	...
	<script type="text/javascript">
        ...
        $(function(){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/notice/showMainPage',
                dataType:'json',
...
<br>
	...
	<table width="98%" align="center" border="0" cellpadding="3"
		...
		<tr>
			<td background="skin/images/frame/wbg.gif" bgcolor="#EEF4EA"
				class='title'><span>通知公告</span><a href='#' style='padding-left: 1260px'>更多...</a></td>
		</tr>
		<tr bgcolor="#FFFFFF">
			<td>
    ...
    <table width="98%" align="center" border="0" cellpadding="3"
		...
		<tr>
			<td colspan="3" background="skin/images/frame/wbg.gif" bgcolor="#EEF4EA"
				class='title'>
				<span>员工论坛</span><a href='#' style='padding-left: 1260px'>更多...</a>
			</td>
		</tr>
		<% for(int i=0;i<12;i++){
		    if (i % 3 == 0) {%>
