...
<c:forEach items="${list}" var="atta" varStatus="index">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="${atta.id}" class="np"></td>
	<td>${index.count}</td>
	<td>${atta.attname}</td>
	<td align="center"><a href=''><u>${atta.attdis}</u></a></td>
	<td>3</td>
	<td>2015-02-03</td>
	<td>2015-06-03</td>
	<td><a href="${pageContext.request.contextPath}/attach/download">下载</a> |<a href="#">删除</a> |<a href="project-file-edit.jsp">编辑</a> | <a href="project-file-look.jsp">查看详情</a></td>
</tr>
