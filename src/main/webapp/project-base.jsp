...
<!--  搜索表单  -->
<form name='form3' action='${pageContext.request.contextPath}/pro/searchList' method='get'>
    ...
    <td background='skin/images/wbg.gif' align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          ...
          <td width='160'>
          <select name='pid' style='width: 50px'>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>${project.level}</td>
	<td><a href="${pageContext.request.contextPath}/pro/update/${project.pid}">编辑</a> | <a href="${pageContext.request.contextPath}/pro/detail/${project.pid}">查看信息详情</a></td>
</tr>
</c:forEach>
