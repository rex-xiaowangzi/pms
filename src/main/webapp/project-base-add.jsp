...
<tr >
	...
	<select name="comname" id="cusList" onchange="parseLeads(this.value)">
		<option>---请选择---</option>
	</select>
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" id="custLeader" name="comper" readonly/></td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" id="finishTime" name="endtime"/>
		<img onclick="WdatePicker({el:'finishTime','skin':'YcloudRed'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
